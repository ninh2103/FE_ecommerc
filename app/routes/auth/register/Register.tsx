    ...
    <div className='container mx-auto px-4 py-10'>
      <div className='mx-auto w-full max-w-md'>
        ...
        <div className='flex items-center justify-center gap-6 mb-4'>
          <Link to='/login' className='text-2xl font-semibold text-slate-400 hover:text-slate-600'>
            Login
          </Link>
        ...
        <form className='space-y-4' onSubmit={handleRegister}>
          ...
          <Button type='submit' className='w-full h-10 bg-purple-600 hover:bg-purple-700 text-white mt-1'>
            {formRegister.formState.isSubmitting ? <LoadingSpinner /> : 'Register'}
          </Button>
        </form>
      </div>
    </div>
